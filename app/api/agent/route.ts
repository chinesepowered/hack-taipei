...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    metadata: agent,
    shield: {
      base_url: process.env.SHIELD_BASE_URL || "https://api.openai.com/v1",
      model: process.env.SHIELD_MODEL || "gpt-5-mini",
      trust_mode: process.env.SHIELD_TRUST_MODE || "verified",
    },
  });
}
